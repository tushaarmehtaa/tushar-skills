...
description: Implement usage credits with atomic spending, grants, purchases, refunds, UI state, limits, and audit history. Use when an app sells or allocates consumable usage.
license: MIT
---

# Credit metering

Implement a complete, auditable credits system across storage, authorization, spending, grants, purchases, refunds, and user-visible state. Read the project first and preserve existing billing semantics.
