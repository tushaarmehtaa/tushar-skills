...
description: Design and build production web interfaces with coherent typography, color, layout, states, and motion. Use when creating pages, dashboards, or components.
license: MIT
---

# Interface design

Build a complete, functional interface with an intentional system. Use the configurable foundations below as starting points, then adapt them to the product, audience, content, and existing brand. Do not expose the author's personal name as the design rationale.
