...
export function SkillDirectory({ skills }: { skills: readonly DirectorySkill[] }) {
  ...
  return (
    <section className="pb-20" aria-labelledby="skill-index-heading">
      ...
      <div className="mb-4 grid gap-3 border-y border-[var(--color-border)] py-4 sm:grid-cols-[minmax(0,1fr)_11rem_11rem_auto] sm:items-end">
        ...
        <label className="block">
          <span className="mb-2 block text-xs text-[var(--color-muted)]">Surface</span>
          <select
