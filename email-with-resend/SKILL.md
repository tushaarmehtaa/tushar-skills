...
description: Implement transactional and product email with Resend, including templates, preferences, audiences, campaigns, and delivery safety. Use when an app needs email.
license: MIT
---

# Email with Resend

Implement product email around Resend: transactional events, lifecycle messages, preferences, audiences, campaigns, delivery observability, and safe admin controls. This is not a cold-outreach workflow.
