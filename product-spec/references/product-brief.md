...
Write a one-page product brief before technical planning. This is the lightweight route within the `product-spec` skill.
...
If the idea is validated and needs technical planning, continue to the buildable-spec route in the `product-spec` skill. The brief comes first; the technical detail follows.
