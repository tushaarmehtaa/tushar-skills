...
description: Analyze a product or competitor across positioning, proof, copy, UX, design, pricing, and onboarding. Use when extracting evidence-backed lessons for another product.
license: MIT
---

# Product teardown

Analyze a product in context and turn observations into applicable lessons. Separate visible evidence from inference, and never copy protected expression, brand assets, or distinctive implementation.
