...
Use the `cold-outreach` skill to draft the outreach.
...
See [ai-search-reference.md](ai-search-reference.md) for complete schema sets, advanced `llms.txt` patterns, citation outreach, and content-gap templates.
